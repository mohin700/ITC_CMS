...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
    ...
    <link href="<?php echo e(asset('front/css/form-validation.css')); ?>" rel="stylesheet">
  </head>
  <body class="bg-light">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <form action="<?php echo e(route('welcome.submit')); ?>" method="POST">
      ...
      <div class="text-center"><?php echo $__env->make('parts.message', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?></div>
...
<script src="<?php echo e(asset('front/js/form-validation.js')); ?>"></script>
</body>
</html>
<?php /**PATH /var/www/html/ems.test/resources/views/welcome.blade.php ENDPATH**/ ?>